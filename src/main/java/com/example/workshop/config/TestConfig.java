...
import com.example.workshop.model.OrderItem;
import com.example.workshop.model.Payment;
import com.example.workshop.model.Product;
import com.example.workshop.model.User;
import com.example.workshop.model.enums.OrderStatus;
...
public class TestConfig implements CommandLineRunner {
	...
	@Autowired
	private OrderItemRepository orderItemRepositor;
	...
	public void run(String... args) throws Exception {
		...
		Order order2 = new Order(null, Instant.parse("2019-07-21T03:42:10Z"), OrderStatus.WATING_PAYMENT, user2); 
		Order order3 = new Order(null, Instant.parse("2019-07-22T15:21:22Z"), OrderStatus.WATING_PAYMENT, user1);
		...
		orderItemRepositor.saveAll(Arrays.asList(orderItem1, orderItem2, orderItem3, orderItem4));
